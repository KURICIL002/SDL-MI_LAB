...
static const _Commands_type_support_symbol_names_t _Commands_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sc_msg, msg, Commands)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sc_msg, msg, Commands)),
  }
};
...
{
  return &::sc_msg::msg::rosidl_typesupport_cpp::Commands_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sc_msg, msg, Commands)() {
  return get_message_type_support_handle<sc_msg::msg::Commands>();
}
