...
#include "sc_msg/msg/detail/commands__rosidl_typesupport_fastrtps_c.h"
...
using _Commands__ros_msg_type = sc_msg__msg__Commands;
...
size_t get_serialized_size_sc_msg__msg__Commands(
  const void * untyped_ros_message,
...
static uint32_t _Commands__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sc_msg__msg__Commands(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sc_msg
size_t max_serialized_size_sc_msg__msg__Commands(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sc_msg__msg__Commands;
    is_plain =
      (
...
static size_t _Commands__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sc_msg__msg__Commands(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sc_msg, msg, Commands)() {
