...
#include "sc_msg/msg/detail/status__rosidl_typesupport_fastrtps_c.h"
...
#include "sc_msg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Status__ros_msg_type = sc_msg__msg__Status;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sc_msg
size_t get_serialized_size_sc_msg__msg__Status(
  const void * untyped_ros_message,
...
static uint32_t _Status__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sc_msg__msg__Status(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sc_msg
size_t max_serialized_size_sc_msg__msg__Status(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sc_msg__msg__Status;
    is_plain =
      (
...
static size_t _Status__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sc_msg__msg__Status(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sc_msg, msg, Status)() {
